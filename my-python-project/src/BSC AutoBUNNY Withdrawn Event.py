...
if __name__ == "__main__":
    ...
    # https://bscscan.com/address/0xc9849e6fdb743d08faee3e34dd2d1bc69ea11a51
    # BUNNY_ADDRESS = '0xC9849E6fdB743d08fAeE3E34dd2D1bc69EA11a51' # Bunny
    # https://bscscan.com/address/0xC004a3b5Af216e9c2c59a9EA8BC3Ee07aF667329
    AUTOBUNNY_ADDRESS = '0xC004a3b5Af216e9c2c59a9EA8BC3Ee07aF667329' # AutoBunny
    ...
    class JSONifiedState(EventScannerState):
        ...
        def process_event(self, block_when: datetime.datetime, event: AttributeDict) -> str:
            ...
            withdrawn = {
                "user": args["user"],
                "amount": args["amount"],
                "withdrawalFee": args["withdrawalFee"],
            ...
            self.state["blocks"][block_number][txhash][log_index] = withdrawn
    ...
    def run():
        ...
        # api_url = 'https://speedy-nodes-nyc.moralis.io/091fa3483427b72ff8999451/bsc/mainnet/archive'
        # api_url = 'https://speedy-nodes-nyc.moralis.io/091fa3483427b72ff8999451/eth/mainnet'
        api_url = 'https://speedy-nodes-nyc.moralis.io/091fa3483427b72ff8999451/bsc/mainnet'
        ...
        scanner = EventScanner(
            ...
            contract=ERC20,
            state=state,
            events=[ERC20.events.Withdrawn],
            filters={"address": AUTOBUNNY_ADDRESS},
